...
class APITokensAdminView(CustomModelView):
    ...
    column_formatters_detail = {
        'token': lambda v, c, m, p: Markup((f'{m.token}<br><br><div class="alert alert-warning" role="alert"><span class="'
                                            f'glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><span class="'
                                            f'sr-only">Error:</span>&nbsp;Keep this token secret and do not use it for other'
                                            f'applications</div>')),
        'user': lambda v, c, m, p: Markup(f'{m.user} <span class="glyphicon glyphicon-user" title="Generated by me"></span>')
