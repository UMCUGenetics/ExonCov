...
class APITokensAdminView(CustomModelView):
    ...
    column_formatters_detail = {
        'token': lambda v, c, m, p: Markup(f'{m.token}<br><br><div class="alert alert-warning" role="alert"><span class="glyph'
                                           f'icon glyphicon-exclamation-sign" aria-hidden="true"></span><span class="sr-only">'
